...
default_size = 128 # edge length for testing, below 350 the model can't process the data
default_epochs = 200
default_batch = 16
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models3D/yololight.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/LIDC.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch-micro.yaml', help='hyperparameters path')
